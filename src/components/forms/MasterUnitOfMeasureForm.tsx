...
interface IMasterUnitOfMeasureForm {
  slug: FormSlugType;
  showIn: "popup" | "page";
}

const basePath = "/masters/products/unit-of-measures";

const MasterUnitOfMeasureForm = (props: IMasterUnitOfMeasureForm) => {
...
export default MasterUnitOfMeasureForm;
