...
const ExpenseFormSlugPage: MyPage = () => {
  ...
  return (
    <>
      ...
      <LiabilityForm slug={slug as FormSlugType} showIn="page" type="expense" />
    </>
  );
};
...
export default ExpenseFormSlugPage;
ExpenseFormSlugPage.Layout = "Dashboard";
