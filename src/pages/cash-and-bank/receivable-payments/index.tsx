...
const pathname = "/cash-and-bank/receivable-payments";

const ReceivablePaymentsPage: MyPage<{ userSession: Session["user"] }> = ({
  userSession,
}) => {
...
export default ReceivablePaymentsPage;
ReceivablePaymentsPage.Layout = "Dashboard";
