...
import LiabilityForm from "@/components/forms/transactions/LiabilityForm";
import type { FormSlugType } from "@/types/global";
import Head from "next/head";
import React from "react";
import { Role } from "@/types/prisma-api/role.d";

const title = "Pendapatan";

const RevenueFormSlugPage: MyPage = () => {
  ...
  return (
    <>
      ...
      <LiabilityForm slug={slug as FormSlugType} showIn="page" type="revenue" />
    </>
  );
};
...
export default RevenueFormSlugPage;
RevenueFormSlugPage.Layout = "Dashboard";
