...
const title = "Pembayaran Hutang";

const PayableFormSlugPage: MyPage = () => {
  ...
  return (
    <>
      ...
      <PaymentForm slug={slug as FormSlugType} showIn="page" type="debt" />
    </>
  );
};
...
export default PayableFormSlugPage;
PayableFormSlugPage.Layout = "Dashboard";
