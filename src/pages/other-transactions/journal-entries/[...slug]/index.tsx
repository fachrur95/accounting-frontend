...
const JournalEntryFormSlugPage: MyPage = () => {
  ...
  return (
    <>
      ...
      <JournalEntryForm slug={slug as FormSlugType} showIn="page" />
    </>
  );
};
...
export default JournalEntryFormSlugPage;
JournalEntryFormSlugPage.Layout = "Dashboard";
