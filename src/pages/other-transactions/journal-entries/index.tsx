...
const JournalEntryForm = dynamic(
  () => import("@/components/forms/transactions/JournalEntryForm"),
);
...
const pathname = "/other-transactions/journal-entries";

const JournalEntriesPage: MyPage<{ userSession: Session["user"] }> = ({
  userSession,
}) => {
