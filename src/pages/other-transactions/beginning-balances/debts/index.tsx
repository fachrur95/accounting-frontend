...
const pathname = "/other-transactions/beginning-balances/debts";

const BeginBalanceDebtsPage: MyPage<{ userSession: Session["user"] }> = ({
  userSession,
}) => {
...
export default BeginBalanceDebtsPage;
BeginBalanceDebtsPage.Layout = "Dashboard";
