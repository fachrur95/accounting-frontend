...
// import BeginningBalanceStockForm from "@/components/forms/transactions/BeginningBalanceStockForm";
...
const BeginningBalanceStockForm = dynamic(
  () => import("@/components/forms/begin-balances/BeginningBalanceStockForm"),
);

const sortDefault: GridSortModel = [{ field: "entryDate", sort: "desc" }];

const title = "Saldo Awal Stock";
const path: WorkerPathType = "transaction";

const pathname = "/other-transactions/beginning-balances/stocks";

const BeginBalanceStockPage: MyPage<{ userSession: Session["user"] }> = ({
  userSession,
}) => {
...
export default BeginBalanceStockPage;
BeginBalanceStockPage.Layout = "Dashboard";
