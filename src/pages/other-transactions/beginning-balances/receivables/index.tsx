...
// import BeginningBalanceDebtReceivableForm from "@/components/forms/transactions/BeginningBalanceDebtReceivableForm";
...
const BeginningBalanceDebtReceivableForm = dynamic(
  () =>
    import(
...
const pathname = "/other-transactions/beginning-balances/receivables";

const BeginBalanceReceivablesPage: MyPage<{ userSession: Session["user"] }> = ({
  userSession,
}) => {
...
export default BeginBalanceReceivablesPage;
BeginBalanceReceivablesPage.Layout = "Dashboard";
