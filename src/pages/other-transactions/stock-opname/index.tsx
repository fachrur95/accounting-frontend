...
// import StockOpnameForm from "@/components/forms/transactions/StockOpnameForm";
...
const StockOpnameForm = dynamic(
  () => import("@/components/forms/transactions/StockOpnameForm"),
);
...
const pathname = "/other-transactions/stock-opname";

const StockOpnamesPage: MyPage<{ userSession: Session["user"] }> = ({
  userSession,
}) => {
