...
const StockOpnameFormSlugPage: MyPage = () => {
  ...
  return (
    <>
      ...
      <StockOpnameForm slug={slug as FormSlugType} showIn="page" />
    </>
  );
};
...
export default StockOpnameFormSlugPage;
StockOpnameFormSlugPage.Layout = "Dashboard";
