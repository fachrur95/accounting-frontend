...
const StockAdjustmentForm = dynamic(
  () => import("@/components/forms/transactions/StockAdjustmentForm"),
);
...
const pathname = "/other-transactions/stock-adjustments";

const StockAdjustmentsPage: MyPage = () => {
...
StockAdjustmentsPage.Layout = "Dashboard";
