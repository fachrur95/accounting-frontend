...
const title = "Laporan Pembelian - Ringkas";

const PurchaseSummaryReportPage: MyPage = () => {
  ...
  const onSubmit = async (data: FilterReportType) => {
    const config: AxiosRequestConfig = {
      url: `/api/pdf/transaction-summary?type=purchase&startDate=${data.startDate.toISOString()}&endDate=${data.endDate.toISOString()}`,
      method: "GET",
...
PurchaseSummaryReportPage.Layout = "Dashboard";
