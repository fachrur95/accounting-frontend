...
const title = "Laporan Piutang";

const BalanceSheetReportPage: MyPage = () => {
  ...
  const onSubmit = async (data: FilterReportType) => {
    const config: AxiosRequestConfig = {
      url: `/api/pdf/debt-receivable?type=receivable&startDate=${data.startDate.toISOString()}&endDate=${data.endDate.toISOString()}`,
      method: "GET",
...
BalanceSheetReportPage.Layout = "Dashboard";
