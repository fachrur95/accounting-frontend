...
const title = "Laporan Penjualan - Ringkas";

const SalesSummaryReportPage: MyPage = () => {
  ...
  const onSubmit = async (data: FilterReportType) => {
    const config: AxiosRequestConfig = {
      url: `/api/pdf/transaction-summary?type=sales&startDate=${data.startDate.toISOString()}&endDate=${data.endDate.toISOString()}`,
      method: "GET",
...
SalesSummaryReportPage.Layout = "Dashboard";
