...
const UnitOfMeasureFormSlugPage: MyPage = () => {
  ...
  return (
    <>
      ...
      <MasterUnitOfMeasureForm slug={slug as FormSlugType} showIn="page" />
    </>
  );
};
...
export default UnitOfMeasureFormSlugPage;
UnitOfMeasureFormSlugPage.Layout = "Dashboard";
