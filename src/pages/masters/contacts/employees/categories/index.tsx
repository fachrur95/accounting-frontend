...
const pathname = "/masters/contacts/employees/categories";

const EmployeeCategoriesPage: MyPage = () => {
...
EmployeeCategoriesPage.Layout = "Dashboard";
