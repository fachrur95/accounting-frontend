...
import { customerTabs } from "@/components/tabs/data";
...
const pathname = "/masters/contacts/customers/categories";

const CustomerCategoriesPage: MyPage = () => {
...
CustomerCategoriesPage.Layout = "Dashboard";
