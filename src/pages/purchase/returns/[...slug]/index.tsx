...
const PurchaseReturnFormSlugPage: MyPage = () => {
  ...
  return (
    <>
      ...
      <ReturnForm slug={slug as FormSlugType} showIn="page" type="purchase" />
    </>
  );
};
...
export default PurchaseReturnFormSlugPage;
PurchaseReturnFormSlugPage.Layout = "Dashboard";
